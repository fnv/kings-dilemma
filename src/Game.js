    ...
    { 
      ...
      houses: {
        olwyn: {
          ...
          crave: 0,
          color: 'red',
          agendas: 'This game, gain points if welfare highest',
        ...
        dualak: {
          ...
          id: HOUSE.DUALAK,
          coins: 10,
          power: 9, // + money (AGENDA), (- welfare AGENDA)
          current_bid: null,
          current_vote_type: null,
          top: '470px',
          left: '95px',
          ...
          crave: 6,
          color: 'purple',
          agendas: 'This game, gain points if wealth highest and lose points if welfare lowest',
        ...
        solad: {
          ...
          id: HOUSE.SOLAD,
          coins: 10,
          power: 7, // - influence (AGENDA), - influence, - morale (AGENDA), - welfare, + knowledge (AGENDA), + knowledge, + knowledge
          current_bid: null,
          current_vote_type: null,
          top: '470px',
          left: '95px',
        ...
        crann: {
          ...
          crave: 6,
          color: 'green',
          agendas: 'This game, lose points if wealth lowest and gain 2 coins whenever research rises',
