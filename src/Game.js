...
const turnOrder = [HOUSE.OLWYN, HOUSE.DUALAK, HOUSE.SOLAD, HOUSE.CRANN, HOUSE.BLODYN ];
    ...
    { 
      ...
      houses: {
        olwyn: {
          ...
          id: HOUSE.OLWYN,
          coins: 10,
          power: 10, // + welfare (AGENDA), + morale (AGENDA)
          current_bid: null,
          ...
          crave: 2,
          color: 'red',
          agendas: 'This game, gain points if welfare or morale highest',
        ...
        dualak: {
          ...
          id: HOUSE.DUALAK,
          coins: 10,
          power: 8, // + money (AGENDA), - influence (AGENDA)
          current_bid: null,
          current_vote_type: null,
          top: '470px',
          left: '95px',
          ...
          crave: 7,
          color: 'purple',
          agendas: 'This game, gain points if wealth highest and lose points if influence lowest',
          achievement1: 'Stability is in lower half (2/4)',
          achievement2: 'Influence is lowest (0/3)',
          achievement3: 'Wealth is lowest (2/3)',
        ...
        solad: {
          ...
          id: HOUSE.SOLAD,
          coins: 10,
          power: 8, // - influence,  - morale (AGENDA), - welfare (AGENDA), + knowledge (AGENDA), + knowledge, + knowledge
          current_bid: null,
          current_vote_type: null,
          top: '470px',
          left: '95px',
          ...
          crave: 12,
          color: 'blue',
          agendas: 'This game, gain points if knowledge highest, lose points if morale or welfare lowest',
          achievement1: 'UNLOCKED - Gain 2 coin when you sign a sticker',
          achievement2: 'UNLOCKED - Gain 3 prestige',
          achievement3: 'Score 2+ points from agendas (1/3)',
        ...
        crann: {
          ...
          achievement1: 'UNLOCKED - Lose 1 less for Negative Agendas',
          achievement2: 'Influence is highest (1/3)',
          achievement3: 'Stability is in lower half (2/4)',
        ...
        blodyn: {
          ...
          achievement3: 'UNLOCKED - Gain 1 prestige. Start +2 coin per game.',
