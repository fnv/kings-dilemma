...
export const Pandemic = {
    ...
    { 
      ...
      cities: {
        ...
        bogota: {
          ...
          pursuit: false,
          contaminated: false,
          commandCenter: COMMANDCENTER.BUGGED,
          incidents: 0,
          top: '813px',
          left: '435px',
        },
  ...
  */
  moves: {
    ...
    togglePursuit: (G, ctx, cityId) => {
      if (!G.cities[cityId]) {
        return INVALID_MOVE;
      }
      G.cities[cityId].pursuit = !G.cities[cityId].pursuit;
    },
    ...
    addDisease: (G, ctx, cityId) => {
      if (!G.cities[cityId]) {
        return INVALID_MOVE;
      }
      G.cities[cityId].disease = Math.min(G.cities[cityId].disease + 1, 3);
    },
    removeDisease: (G, ctx, cityId) => {
      if (!G.cities[cityId]) {
        return INVALID_MOVE;
      }
      G.cities[cityId].disease = Math.max(G.cities[cityId].disease - 1, 0);
    },
